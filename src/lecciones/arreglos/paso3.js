...
const fruitsPaso3Push = ["apple", "banana"];
const newLengthPaso3 = fruitsPaso3Push.push("orange");
console.log(newLengthPaso3); // 3
console.log(fruitsPaso3Push); // ["apple", "banana", "orange"]
...
let fruitsPaso3Pop = ["apple", "banana", "orange"];
let lastFruitPaso3 = fruitsPaso3Pop.pop();
console.log(fruitsPaso3Pop); // ["apple", "banana"]
console.log(lastFruitPaso3); // "orange"
...
let numbersPaso3 = [2, 3];
let newLengthPaso3Unshift = numbersPaso3.unshift(1);
console.log(numbersPaso3); // [1, 2, 3]
console.log(newLengthPaso3Unshift); // 3
...
let colorsPaso3 = ["red", "green", "blue"];
let firstColorPaso3 = colorsPaso3.shift();
console.log(colorsPaso3); // ["green", "blue"]
console.log(firstColorPaso3); // "red"
